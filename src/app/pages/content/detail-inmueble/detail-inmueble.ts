...
@Component({
  ...
  imports: [Preloader, ParentesisPipe, EurosPipe, CarouselFicha, MetrosCuadradosPipe, MinusculasPipe, AmuebladoPipe, PlazasPipe, SiNoPipe, BotonAdmin, CorazonFavoritos],
